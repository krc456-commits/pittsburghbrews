  ...
  return (
    <main>
      <section className="border-b border-white/8 bg-[#0b0b0a]">
        <div className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-20">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 text-5xl font-black leading-[.95] tracking-[-0.055em] text-[#f5f3ec] sm:text-6xl lg:text-7xl">
              Find your next <span className="text-[var(--gold)]">Pittsburgh brewery.</span>
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
              Built for local beer drinkers. Check what is nearby, find a patio or a kitchen, revisit an old favorite, or discover a brewery you have not tried yet.
            </p>
          ...
          <div className="mt-10 overflow-hidden rounded-xl border border-white/10 bg-[#141413]">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/8 px-4 py-3 text-xs font-bold uppercase tracking-[0.12em] text-zinc-500 sm:px-5">
              <span>Pittsburgh + Western Pennsylvania</span>
              <span>{breweries.length} verified starters · Updated Sep 2026</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-[-.035em] text-[#f5f3ec] md:text-5xl">What are you in the mood for?</h2>
            </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {browseOptions.map((item) => (
              <Link key={item.label} href={item.href} className="group rounded-xl border border-white/8 bg-[#151514] p-5 transition hover:-translate-y-0.5 hover:border-white/20 hover:bg-[#191917]">
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
          <div className="grid gap-8 lg:grid-cols-[.72fr_1.28fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-black tracking-[-.04em] text-[#f5f3ec] md:text-6xl">A few places to start.</h2>
              <p className="mt-4 max-w-lg leading-7 text-zinc-500">No rankings and no sponsored placement. Just useful information to help you decide where to grab a beer next.</p>
            </div>
      ...
      <div className="bg-[#0b0b0a] px-5 pb-5 text-center text-[10px] text-zinc-700 md:px-8">
        Skyline photo: Dough4872 / Wikimedia Commons, CC BY-SA 4.0 · <Link href="/credits" className="underline hover:text-zinc-400">image credits</Link>
      </div>
    </main>
  );
}
